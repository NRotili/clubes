        ...
        <nav class="flex-1 px-3 py-5 space-y-6 overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-slate-900 [&::-webkit-scrollbar-thumb]:bg-slate-600 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-slate-500">
            ...
            <div>
                ...
                <ul class="space-y-0.5">
                    ...
                    <li>
                        <a href="{{ route('solicitudes-eliminacion.index') }}"
                            class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                                {{ request()->routeIs('solicitudes-eliminacion.*') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                            <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0"/>
                            </svg>
                ...
                <nav class="px-4 py-3 flex flex-col gap-0.5">
                    ...
                    <div class="mobile-section">
                        ...
                        <div id="m-config" class="flex flex-col gap-0.5 pl-2 {{ $hidden }}">
                            ...
                            <a href="{{ route('solicitudes-eliminacion.index') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('solicitudes-eliminacion.*') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-100' }}">Eliminación de cuentas</a>
                            @if(auth()->user()->esDesarrollador())
