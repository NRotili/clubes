...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'identificador' => [
            'required' => 'Ingresá tu número de socio o tu DNI.',
        ],
        'numero_documento' => [
            'unique' => 'Ya existe un socio registrado con ese número de documento.',
        ],
        'numero_socio' => [
            'unique' => 'Ya existe un socio con ese número de socio.',
        ],
        'password' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'identificador'     => 'número de socio o DNI',
